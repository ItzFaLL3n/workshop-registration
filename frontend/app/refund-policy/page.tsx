...
export default function RefundPolicyPage() {
  return (
    <LegalPageLayout title="Refund &amp; Cancellation Policy" updated="[DATE — confirm before publishing]">
      {DRAFT_NOTICE && (
        <div
          style={{
            background: "#eaf7ef",
      ...
      <div>
        ...
        <P>
          If you wish to cancel your registration, contact us at [CONTACT EMAIL] at least
          [X DAYS] before the workshop date. Requests made after this window
          [ARE / ARE NOT — pick one] eligible for a refund. Once approved, refunds are processed
      ...
      <div>
        ...
        <P>
          ...
          participants will receive a full refund, processed within [5–7] business days of the
          cancellation being announced. If the workshop is rescheduled to a new date, your
          registration carries over automatically unless you request a refund within [X DAYS] of
      ...
      <div>
        ...
        <P>
          ...
          charged more than once, contact [CONTACT EMAIL] with your payment reference — this will
          be verified and any erroneous charge refunded in full within [5–7] business days. (Note:
      ...
      <div>
        <H2>5. Contact</H2>
        <P>
          For any refund or cancellation request, email [CONTACT EMAIL] with your registered name
          and email address.
        </P>
      </div>
    </LegalPageLayout>
